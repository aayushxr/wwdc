    ...
    <div className="flex flex-col min-h-screen">
                ...
                <ul className="grid gap-6">
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-neutral-500 dark:text-neutral-400">
                        Guiding students on their academic and personal journeys
                        through tailored mentorship.
                      </p>
                    </div>
                  </li>
                  <li>
                    <div className="grid gap-1">
                      <h3 className="text-xl font-bold">Dynamic Connections</h3>
                      <p className="text-neutral-500 dark:text-neutral-400">
                  ...
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-neutral-500 dark:text-neutral-400">
                        Cultivate social responsibility by encouraging students
                        to engage in community service projects and advocate for
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-neutral-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-neutral-400">
                  ...
                  education; we aspire to cultivate a transformative environment
                  where mentors from universities play a pivotal role in
                  nurturing students
                </p>
              </div>
            </div>
                  ...
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-neutral-500 dark:text-neutral-400">
                        ...
                        diverse organizations, providing real-world experiences
                        and contributing to impactful initiatives.
                      </p>
                    </div>
                  </li>
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-neutral-500 dark:text-neutral-400">
                        Beyond academic success, our goal is to empower students
                        to have a tangible impact on their communities, creating
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-neutral-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-neutral-400">
                  ...
                  are strategically incorporating various methodologies aimed at
                  ...
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-neutral-500 dark:text-neutral-400">
                        ...
                        volunteering opportunities and participation in various
                        competitions for like-minded youth.
                      </p>
                    </div>
                  </li>
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-neutral-500 dark:text-neutral-400">
                        Host a fortnightly podcast featuring individuals sharing
                        valuable insights to enhance the high school experience.
                      </p>
                    </div>
                  </li>
                  <li>
      ...
      <footer className="container flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 ">
        ...
        <nav className="sm:ml-auto flex gap-4 sm:gap-6 text-neutral-400">
          <Link className="text-xs hover:underline underline-offset-4" href="https://aayushr.dev">
