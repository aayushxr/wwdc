    ...
    <main className="flex-1 flex-col">
      <div className="container h-full flex">
        ...
        <div className="flex items-start justify-center z-20  max-w-6xl">
          <div className=" pt-20 ">
            <h1 className="text-4xl max-w-6xl relative z-50 text-center font-bold leading-snug tracking-tight text-zinc-900 lg:text-4xl lg:leading-tight xl:text-5xl xl:leading-tight dark:text-white">
              {title}
            </h1>
